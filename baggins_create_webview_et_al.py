...
def openWebPage2(page=None,traditional=False,webv=None,name="Baggins",version="2.3",mainpage=None,private=False,kiosk=False,title=None,autoclosable=False,boxonly=False,search_engine="https://duckduckgo.com/?q=",aid="org.freedesktop.Baggins",parent=None,application=None,webvkeypress=None):
	if (aid==None):
